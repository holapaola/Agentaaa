...
const stats = [
  { label: 'Connected Accounts', value: '4', icon: Users, color: 'text-blue-500', bg: 'bg-blue-50' },
  { label: 'Scheduled Posts', value: '12', icon: FileText, color: 'text-purple-500', bg: 'bg-purple-50' },
  { label: 'Total Impressions', value: '84.2K', icon: TrendingUp, color: 'text-green-500', bg: 'bg-green-50' },
  { label: 'Pending Actions', value: '5', icon: Zap, color: 'text-orange-500', bg: 'bg-orange-50' },
];
